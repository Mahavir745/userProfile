...
const User = ({data}) => {
  return (
    <div className='flex flex-col items-center gap-10 w-[300px] m-auto mt-4 mb-4 md:flex-row md:w-[800px] lg:w-[1000px]'>
      ...
      <div className='w-[360px] h-[auto] md:w-[500px] lg:w-[700px] border'>
        <h1 className='text-2xl  bg-gray-600 text-white border p-2'>Name: <span className='text-2xl text-emerald-100 '>{data.username}</span></h1>
        <p className='text-2xl bg-gray-600 text-white border p-2'>Email: <span className='text-2xl text-emerald-100 '>{data.email}</span></p>
        <p className='text-2xl bg-gray-600 text-white border p-2'>Contact: <span className='text-2xl text-emerald-100 '>{data.contact}</span></p>
